...
local getBestTarget do
    getBestTarget = function()
        local mouse = UIS:GetMouseLocation()
        local near, minDist = nil, Config.FOV
            ...
            if p ~= LP and p.Character then
                ...
                if bone then
                    ...
                    if on then
                        ...
                        if d < minDist then near, minDist = bone, d end
                    end
                end
            end
        end
...
local function predict(pos, vel)
    ...
    return pos + vel * bulletTime + Vector3.new(0, -drop, 0)
end
...
-- ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
--  UI
local Win = OrionLib:MakeWindow({Name = "Hypershot V2  •  FINAL", SaveConfig = true, ConfigFolder = "HypershotV2"})
