...
-- ESP Library
local esp = loadstring(game:HttpGet("https://raw.githubusercontent.com/SiriusSoftwareLtd/ESP-Library/main/nomercy.rip/source.lua"))()
...
local MainSection = CombatTab:CreateSection("Silent Aim")
...
esp.Settings.Box.Color = Color3.fromRGB(0, 146, 214)
esp.Settings.Box.OutlineColor = Color3.fromRGB(0, 170, 255)
esp.Settings.Box.Outline = true
esp.Settings.Name.Enabled = true
esp.Settings.Name.TextSize = 14
esp.Settings.Name.TextStrokeColor = Color3.fromRGB(0, 0, 0)
esp.Settings.Name.TextStrokeTransparency = 0.5
esp.Settings.HealthBar.Enabled = true
esp.Settings.HealthBar.Color = Color3.fromRGB(0, 255, 0)
esp.Settings.HealthBar.BackgroundColor = Color3.fromRGB(50, 50, 50)
esp.Settings.HealthBar.Position = "Top"
